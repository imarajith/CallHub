...
class TestMonthly:
    # checks monthly option is available
    ...
    # Verifies Monthly > business amount
    ...
    # Verifies Monthly > business billed amount
    ...
    # Verifies Monthly > premium amount
    ...
    # Verifies Monthly > pay as you go amount
